...
(function(){
  var fs, fsExtra, path, crypto, readChunk, sharp, expressFormidable, uploadr, expressRateLimit, aux, grecaptcha;
  fs = require('fs');
  ...
  (function(it){
    ...
    var api, app, throttling, thr, clearUserCookie, renderProfile;
    api = engine.router.api;
    app = engine.app;
    throttling = thr = {
      base: expressRateLimit({
